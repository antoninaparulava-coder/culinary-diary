...
export const recipes: Recipe[] = [
  {
    ...
    uses: ["Tomato", "Basil", "Sourdough", "Olive Oil", "Garlic", "Salt"],
    emoji: "🍅",
  ...
  },
  {
    ...
    uses: ["Lemon", "Garlic", "Spinach", "Parmesan", "Olive Oil", "Pasta"],
    emoji: "🍝",
  ...
  },
  {
    ...
    uses: ["Strawberry", "Basil", "Sourdough", "Butter"],
    emoji: "🍓",
  ...
  },
  {
    ...
    difficulty: "Medium",
    tags: ["Brunch"],
    uses: ["Egg", "Garlic", "Parmesan", "Sourdough", "Olive Oil", "Flatbread"],
    emoji: "🥚",
  ...
  },
  {
    ...
    difficulty: "Easy",
    tags: ["Salad", "Light"],
    uses: ["Spinach", "Lemon", "Olive Oil", "Parmesan", "Pepper"],
    emoji: "🥗",
  ...
  },
  {
    ...
    difficulty: "Medium",
    tags: ["Soup", "Comfort"],
    uses: ["Tomato", "Garlic", "Olive Oil", "Sourdough", "Onion", "Broth"],
    emoji: "🍲",
